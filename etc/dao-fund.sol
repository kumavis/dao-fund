...
contract WeiFund 
{
    ...
    // join table
    function userCampaigns(address _addr, uint _u_cid) constant returns (uint cid)
    {
        User u = users[_addr];
    ...
    {
        Campaign c = campaigns[_cid];
        // Campeign expired and funding goal not met and funds remaining.
